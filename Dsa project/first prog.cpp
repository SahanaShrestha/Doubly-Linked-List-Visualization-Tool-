...
// function to insert node from beginning
void isbg(int datastore)
{
//    clearheader()
    // insertion from beginning page graphics
    //.............................................................
//    setfillstyle(1,14);
//    bar(0,70,getmaxx(),80);
//    bar(0,getmaxy()-80,getmaxx(),getmaxy()-70);
...
// function to insert from the end
void isend(int datastore)
{
//    clearheader();
    // insertion from end page graphics
    //.............................................................
//    setfillstyle(1,14);
//    bar(0,70,getmaxx(),80);
//    bar(0,getmaxy()-80,getmaxx(),getmaxy()-70);
...
// function to add data in specified location
void issp()
{
//    clearheader();
    clearfooter();
    // insertion in specified position page graphics
    //.............................................................
//    setfillstyle(1,14);
//    bar(0,70,getmaxx(),80);
//    bar(0,getmaxy()-80,getmaxx(),getmaxy()-70);
...
//    outtextxy(getmaxx()/2-420,20,"Doubly Linked List Insertion");
    ...
    else
    {
        ...
        clearfooter();
//        setfillstyle(1,0);
//        bar(0,getmaxy()-50,getmaxx(),getmaxy()-20);
        displaymodule();
        outtextxy(0,getmaxy()-50,"Data successfully added");
        getch();
    }
}


// function to insert node from specified location end
void isspe()
{
    clearfooter();
    settextstyle(4,0,2);
...
//    char data[20];
    ...
    if (pfirst == NULL)
    {
        setfillstyle(1,0);
        clearfooter();
        outtextxy(0,getmaxy()-50,"The node is empty");
        getch();
        return (0);
    }
...
void insertion()
{
    ...
    outtextxy(getmaxx()/2-420,20,"Doubly Linked List Insertion");
    settextstyle(4,0,2);
    outtextxy(30,getmaxy()-50,"1.Beginning");
    outtextxy(430,getmaxy()-50,"2.End");
...
void deletion()
{
    ...
    outtextxy(30,getmaxy()-50,"1.Beginning");
    outtextxy(430,getmaxy()-50,"2.End");
    outtextxy(830,getmaxy()-50,"3.Specified Location");
    outtextxy(getmaxx()-150,30,"0.Exit");
    //.................................................................
    getins=getch();
    switch(getins)
...
void displaymodule()
{
    ...
    if(pfirst==NULL)
    {
        outtextxy(100,300,"No any node");
    }
    else
    {
        for (int i = 0; i < count; i++)
        {
            stringstream sp,sn;// make the function which directly converts pointer to string in simple function
            ...
            nodbox(display_position,ppp,ddd,nnn);
//        cout<<ppp<<"\t"<<ddd<<"\t"<<nnn<<endl;
//        cout<<pthis->pprev<<"\t"<<pthis->data<<"\t"<<pthis->pnext<<endl;
            pthis = pthis->pnext;
            display_position++;
        }
    }
