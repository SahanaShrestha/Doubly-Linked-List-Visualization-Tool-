...
void nod(int x, int y, string prev, string data, string next, bool direction)
{
    if(direction)
    {
        ...
        outtextxy(x+20+150+100,y+18,const_cast<char*>(next.c_str()));
    ...
    else
    {
        ...
        outtextxy(x+20+150,y+18,const_cast<char*>(data.c_str()));
        rectangle(x+160,y+10,x+250,y+40);                                // inner 2 rectangle ::data field
        outtextxy(x+20+150+100,y+18,const_cast<char*>(prev.c_str()));
        rectangle(x+260,y+10,x+390,y+40);                                // inner 3 rectangle ::next field address
    }
...
void nodbox(int position, string pp, string dd, string nn)
{
    switch(position)
    {
    case 1:
            nod(50,200,pp,dd,nn,true);
            break;
    case 2:
            nod(550,200,pp,dd,nn,true);
            arrow(1);
            break;
    case 3:
            nod(1050,200,pp,dd,nn,true);
            arrow(2);
            break;
    case 4:
            nod(1050,400,pp,dd,nn,false);
            arrow(3);
            break;
    case 5:
            nod(550,400,pp,dd,nn,false);
            arrow(4);
            break;
    case 6:
            nod(50,400,pp,dd,nn,false);
            arrow(5);
            break;
    case 7:
            nod(50,600,pp,dd,nn,true);
            arrow(6);
            break;
    case 8:
            nod(550,600,pp,dd,nn,true);
            arrow(7);
            break;
    case 9:
            nod(1050,600,pp,dd,nn,true);
            arrow(8);
            break;
    default:
            break;
